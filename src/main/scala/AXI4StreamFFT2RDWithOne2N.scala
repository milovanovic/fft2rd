...
// //import dsputils._
//
// trait AXI4FFT2RDWithOne2NStandaloneBlock extends AXI4StreamFFT2RDWithOne2NBlock[FixedPoint] {
...
// }
//
// class AXI4StreamFFT2RDWithOne2NBlock [T <: Data : Real: BinaryRepresentation] (val params: FFT2RDParams[T], val beatBytes: Int) extends LazyModule()(Parameters.empty) {
//   // number of chirps
...
// }
//
// object FFT2RDWithOneToNDspBlockAXI4 extends App
// {
...
//
//   val fft2Module = LazyModule(new AXI4StreamFFT2RDWithOne2NBlock(paramsFFT2RD, beatBytes = 4) with AXI4FFT2RDWithOne2NStandaloneBlock)

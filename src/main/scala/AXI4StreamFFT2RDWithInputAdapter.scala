...
class AXI4StreamFFT2RDWithInputAdapter[T <: Data: Real: BinaryRepresentation](
...
object FFT2RDWithInputAdapterDspBlockAXI4 extends App {
  ...
  val fft2Module = LazyModule(
    new AXI4StreamFFT2RDWithInputAdapter(paramsFFT2RD, beatBytes = 4) with AXI4FFT2RDWithInputAdapterStandaloneBlock
  )

...
//
// import fft._
// import headerInserter._
// import zeropadder._
//
// trait AXI4FFT2WithIAandHIStandaloneBlock extends AXI4StreamFFT2WithIAandHI[FixedPoint] {
...
// }
//
// class AXI4StreamFFT2WithIAandHI [T <: Data : Real: BinaryRepresentation] (val params: FFT2Params[T], mode1024: Boolean = true, hIAddress: AddressSet, val beatBytes: Int) extends LazyModule()(Parameters.empty) {
//
...
// }
//
// object FFT2WithIAandHIDspBlockAXI4 extends App
// {
...
//   val fft2Module = LazyModule(new AXI4StreamFFT2WithIAandHI(paramsFFT2, mode1024, hiAddress, beatBytes = 4) with AXI4FFT2WithIAandHIStandaloneBlock)
